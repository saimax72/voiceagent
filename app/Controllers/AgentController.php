...
final class AgentController
{
    ...
    public function update(Request $request, string $id): Response
    {
        ...
        Agents::update((int) $agent['id'], [
            ...
            'auto_speak' => $request->string('speak_replies') === 'never' ? 0 : 1,
            'speak_replies' => in_array($request->string('speak_replies'), ['voice', 'always', 'never'], true) ? $request->string('speak_replies') : 'voice',
            'interruptible' => $request->boolean('interruptible') ? 1 : 0,
