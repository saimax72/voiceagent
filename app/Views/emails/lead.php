...
<table role="presentation" cellspacing="0" cellpadding="0" style="width:100%;border:1px solid #e6e8f0;border-radius:12px;margin:18px 0;">
...
<p style="margin:24px 0;"><a href="<?= e($link) ?>" style="background:#5b5bd6;color:#fff;text-decoration:none;padding:12px 22px;border-radius:10px;font-weight:600;display:inline-block;">View in dashboard</a></p>
