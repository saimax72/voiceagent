      ...
      <div class="form-group">
        ...
        <div class="choice-grid">
          <?php foreach ($personas as $key => $p): ?>
            <label class="choice-card"><input type="radio" name="persona" value="<?= e($key) ?>" <?= old('persona', $agent['persona']) === $key ? 'checked' : '' ?>><span class="choice-check"></span><span class="choice-body"><span class="choice-title"><?= e($p['label']) ?></span><span class="choice-desc"><?= e($p['description']) ?></span></span></label>
          <?php endforeach; ?>
        </div>
      </div>
      <div class="form-row">
